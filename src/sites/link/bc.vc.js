(function () {
  ...
  $.register({
    rule: {
      host: /^gx\.si|(adwat|ysear)\.ch|(fly2url|urlwiz|xafox)\.com|(zpoz|ultry)\.net|(wwy|myam)\.me|ssl\.gs|link\.tl|xip\.ir|hit\.us|shortit\.in|(adbla|tl7)\.us|www\.adjet\.eu|srk\.gs|cun\.bz|adtr\.im$/,
      path: /^\/.+/,
    },
    ready: run,
  });
