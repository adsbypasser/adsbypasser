  ...
  _.register({
    rule: {
      host: [
        ...
        /^(earnmoneytalk|yourw-ay|reb7konline|enewstalk|newupdatesonline)\.com$/,
        /^(uptoos|bakilink|gossipcorners|jainjinvani)\.com$/,
        // net
        ...
        /^(shink|shrten|gg-l|vnurl|bloggingdekh|sh11|ln11)\.xyz$/,
        /^(mlink|cl250)\.club$/,
        /^(igram|gram)\.im$/,
